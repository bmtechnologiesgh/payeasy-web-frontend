  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div
        ...
        className={`flex gap-4 overflow-x-auto scroll-smooth pb-1 pt-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden max-md:snap-x max-md:snap-mandatory touch-pan-x ${trackClassName}`}
      >
        {children}
      </div>
    </div>
