...
import { login } from "@/lib/merchant-api";
  ...
  return (
    <div className="w-full max-w-[440px]">
      <PageHeader
        ...
        subtitle="Use the email and password you registered with PayEasy."
      />
            ...
            <Link
              href={
                email.trim()
                  ...
                  : portalHref("merchant", "/forgot-password")
              }
      ...
      <p className="mt-6 text-center text-sm text-[color:var(--color-muted)]">
        ...
        <Link
          href={portalHref("merchant", "/register")}
